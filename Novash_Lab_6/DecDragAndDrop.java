        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    private ArrayList<CustomShape> witches = new ArrayList();
    private CustomShape beingDragged; // The scribble being dragged
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.setStroke(new MyStroke(2f)); // Specify wide lines
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (CustomShape witch : witches) { // Loop through the scribbles
    ...
    public void drop(DropTargetDropEvent e) {
        ...
        CustomShape droppedScribble; // This will hold the Scribble object
